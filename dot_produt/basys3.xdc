...
set_property PACKAGE_PIN V2 [get_ports {SW_digit[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW_digit[0]}]
set_property PACKAGE_PIN T3 [get_ports {SW_digit[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {SW_digit[1]}]
